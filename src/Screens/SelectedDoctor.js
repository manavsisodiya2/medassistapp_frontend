          ...
          <div className={classes.box2}>
            <Grid container>
                ...
                <Grid item xs={11}>
                    ...
                    <div>
                    <Button style={{variant: "contained",background: "#22a6b3",borderRadius: 100,height: 40,color: "#ffff",fontSize: 15,paddingLeft: 30,paddingRight: 30, }}>Change Doctor</Button>
                    </div>
                </Grid>
            </Grid>
          </div>
