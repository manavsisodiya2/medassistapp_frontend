...
{   const handleClick=(index)=>{
    ...
    return(<Paper  onClick={()=>handleClick(props.i)}  elevation={2} style={{background:props.i==props.selectedDoctor?'#f7f1e3':'#ffff', width:200,height:'auto',margin:'0px 0px 15px 15px',padding:10}}>
